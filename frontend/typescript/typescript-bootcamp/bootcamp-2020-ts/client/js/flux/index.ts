...
export const createAddTodoAction = (todo: Partial<todo.TodoType>) => ({
  type: ADD_TODO_ACTION_TYPE,
  payload: todo
});

const UPDATE_TODO_ACTION_TYPE = "Update todo state";
export const updateTodoAction = (todo: Partial<todo.TodoType>) => ({
  type: UPDATE_TODO_ACTION_TYPE,
  payload: todo
});

const REMOVE_TODO_ACTION_TYPE = "Remove todo";
export const removeTodoAction = (todo: Partial<todo.TodoType>) => ({
