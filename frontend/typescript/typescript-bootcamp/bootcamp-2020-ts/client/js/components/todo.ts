...
class Todo {
  ...
  constructor(parent: HTMLLIElement, props: TodoType) {
    this.parent = parent;
  ...
  mount() {
    ...
    const toggle: HTMLInputElement | null = this.element.querySelector(".todo-toggle");
    toggle?.addEventListener("click", () => {
      this.props.done = !this.props.done;
      store.dispatch(updateTodoAction(this.props));
    });
    const removeButton: HTMLInputElement | null = this.element.querySelector(".todo-remove-button");
